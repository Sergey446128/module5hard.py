...
if __name__ == '__main__':
    ...
    ur = UrTube()
    v1 = Video('Лучший язык прогромирования 2024 года', 200)
...
# Проверка на вход пользователя и возростное ограничение
ur.watch_video('Для чего девушкам парень программист?')
ur.register('vasya_pupkin', 'lolkekcheburek', 13)
ur.watch_video('Для чего девушкам парень программист?')
ur.register('urban_pythonist', 'iScX4vIJCIb9QavjAgF', 25)
ur.watch_video('Для чего девушкам парень программист?')
